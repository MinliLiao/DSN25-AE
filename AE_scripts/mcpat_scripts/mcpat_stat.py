...
LSL_message_size = 2
LLC_response_size = 3
L1D_numAccess = "stats_value[\"system.cpu0.dcache.ReadReq.accesses::total\"] + stats_value[\"system.cpu0.dcache.WriteReq.accesses::total\"]"
LLC_numAccess = "stats_value[\"system.l3.ReadCleanReq.accesses::total\"] + stats_value[\"system.l3.ReadExReq.accesses::total\"]"# + stats_value[\"system.l3.WritebackDirty.accesses::total\"]"
LSL_numPackts = "math.ceil((" + L1D_numAccess + ") / 4) * LSL_message_size"
LLC_numResponses = "(" + LLC_numAccess + ") * LLC_response_size"
NOC_numAccess_Baseline = "(" + LLC_numAccess + ") + (" + LLC_numResponses + ")"
NOC_numAccess_Checked = "(" + NOC_numAccess_Baseline + ") + (" + LSL_numPackts + ")"
...
if "X2" in args.statFile or "A510" in args.statFile:
    NOC_numAccess = eval(NOC_numAccess_Checked)
else:
    NOC_numAccess = eval(NOC_numAccess_Baseline.replace("cpu0","cpu"))
